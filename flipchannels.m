...
void process_file() {
    int i;
    png_byte the_color_type = png_get_color_type(png_ptr, info_ptr);;
    if (the_color_type != PNG_COLOR_TYPE_RGBA)
        abort_("[process_file] color_type of input file must be PNG_COLOR_TYPE_RGBA (is %d)", the_color_type);
